...
export const capabilities = [
  'Public-sector bid response, vendor positioning, and opportunity shaping',
  'Project management, owner-side coordination, and delivery follow-through',
  'Mechanical, construction, and healthcare-adjacent service models',
...
export const operatingPrinciples = [
  {
    name: 'Validate',
    body: 'Check the real demand, buyer, constraints, risks, and proof before turning an idea into an offer.',
  },
  {
    name: 'Investigate',
    body: 'Map the site, sector, system, people, timing, and commercial path deeply enough to know where leverage actually is.',
  },
  {
    name: 'Iterate',
    body: 'Use live work, feedback, documentation, and tooling to improve the offer without losing the thread.',
  },
];

export const inquiryRoutes = [
  'Public-sector opportunity or bid',
  'Mechanical service or project support',
  'Healthcare-adjacent facility support',
  'Construction or general contracting work',
  'AI infrastructure or applied AI project',
  'Partnership, investment, or venture inquiry',
];
...
export const capabilityStatement = [
  ...
  },
  {
    ...
    value: 'Public-sector buyers, facility operators, owners, project stakeholders, technical partners, and early customers.',
  },
  {
  ...
  },
  {
    ...
    value: 'Founder-led judgment, practical field orientation, disciplined documentation, and AI-assisted execution systems.',
  },
];
